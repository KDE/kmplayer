...
public:
    PlaylistItemBase (KMPlayer::NodePtr & doc, short id, KMPlayerApp *a);
    void activate ();
    void closed ();
    KMPlayerApp * app;
};
...
KDE_NO_CDTOR_EXPORT
PlaylistItemBase::PlaylistItemBase (KMPlayer::NodePtr &d, short i, KMPlayerApp *a)
    : KMPlayer::Mrl (d, i), app (a) {
}
...
PlaylistItem::PlaylistItem (KMPlayer::NodePtr & doc, KMPlayerApp *a, const QString &url)
 : PlaylistItemBase (doc, KMPlayer::id_node_playlist_item, a) {
    src = url;
    setAttribute (KMPlayer::StringPool::attr_url, url);
}
...
HtmlObject::HtmlObject (KMPlayer::NodePtr &doc, KMPlayerApp *a, bool pm)
  : PlaylistItemBase (doc, KMPlayer::id_node_html_object, a), playmode (pm) {}
...
KDE_NO_EXPORT void IntroSource::activate () {
    ...
    if (file.exists () && file.open (IO_ReadOnly)) {
        ...
        QString smil = QString::fromLatin1 (
          ...
          "<excl>"
          "<par>"
          "<img src='%1' region='image1' dur='.6' fit='fill'/>"
          "<animate target='image1' attribute='width' from='37.5%' to='1%' begin='.3' dur='0.3' fill='freeze'/>"
          "<animate target='image1' attribute='left' from='31.25%' to='50%' begin='.3' dur='0.3' fill='freeze'/>"
          "<animate target='image1' attribute='height' from='50%' to='1%' begin='.3' dur='0.3' fill='freeze'/>"
          "<animate target='image1' attribute='top' from='25%' to='50%' begin='.3' dur='0.3' fill='freeze'/>"
...
KDE_NO_EXPORT void ExitSource::activate () {
    ...
    if (file.exists () && file.open (IO_ReadOnly)) {
        ...
        QString smil = QString::fromLatin1 ("<smil><head><layout>"
          ...
          "<animate target='image' attribute='top' from='72' to='136' dur='0.3' fill='freeze'/>"
          "<img src='%2' region='image' dur='0.4' fit='hidden'/>"
          "</par>"
